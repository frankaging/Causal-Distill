    ...
    if training_args.do_eval:
        ...
        if my_file.is_file():
            ...
            with open(eval_metrics_output_path, mode='w') as csv_file:
                ...
                csv_writer.writerow([
                    "training_paradigm", "neuron_mapping", "interchange_method", "include_causal_cos", "seed", "glue_task", "split", "metrics", "performance"
                ])
        ...
        for eval_dataset, task in zip(eval_datasets, tasks):
            ...
            for m in task_to_metrics[task]:
                with open(eval_metrics_output_path, mode='a') as csv_file:
                    ...
                    csv_writer.writerow([
                      out_condition, 
                        out_neuron_mapping, out_interchange_method, 
                        out_include_causal_cos, out_seed, task, 
                        "eval", m, metrics[f"eval_{m}"],
                    ])
